...
function FocusDemo() {
  ...
  return (
    <>
      <div className="SH-added">
        <p>Click on an item to focus it.</p>
        <p>Notice that as the items are shuffled..</p>
        <p>the focus properly tracks the item,</p>
        <p>*only if* a *proper* `key` property was set!</p>
      </div>
      <div className="keys">
        <div>
          <h1>Without a key</h1>
